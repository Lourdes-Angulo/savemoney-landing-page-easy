  ...
  const planes = [
    {
      ...
      precio: "0.00",
      caracteristicas: [
        "Registro Manualmente de ingresos y gastos",
        "Registro por voz y foto limitado",
        "Gráfico mensual",
        "Categorías básicas",
        "Retos y recordatorios limitados"
      ],
    ...
    },
    {
      ...
      caracteristicas: [
        "Registro Manualmente de ingresos y gastos",
        "Registro por voz y foto ilimitado",
        "Gráfico mensual y pdf de reportes",
        "Categorías básicas",
        "Retos y recordatorios ilimitados"
      ],
